/**
 * SHA-256（纯 JS 回退实现 + WebCrypto 优先）。
 *
 * 之所以要纯 JS 版本：登录页可能通过 http:// 访问局域网地址，
 * 属于非安全上下文，此时 `crypto.subtle` 不存在。
 */
...
export function sha256Pure(data) {
...
/** 优先用 WebCrypto，不可用（非安全上下文）时回退纯 JS 实现 */
